...
$state = Get-AppState
$candidates = @($state.companies | Where-Object { $_.enrichmentStatus -eq $null -or $_.enrichmentStatus -eq '' } | Select-Object -First 10)
$result = Invoke-CompanyEnrichment -State $state -AccountIds ($candidates | ForEach-Object { $_.id }) -Limit 10
$failures = @{}
